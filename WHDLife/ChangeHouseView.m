...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.userInfoLb.text = [NSString stringWithFormat:@"%@%@%@%@%@", defaultUserHouse.cellName, defaultUserHouse.regionName, defaultUserHouse.buildingName, defaultUserHouse.unitName, defaultUserHouse.numberName];
    ...
    if ([defaultUserHouse.numberId isEqualToString:house.numberId] == YES) {
        ...
        [cell.changeBtn setBackgroundImage:[UIImage imageNamed:@"repair_red_s"] forState:UIControlStateDisabled];
    }
    else
    {
        ...
        [cell.changeBtn setBackgroundImage:[UIImage imageNamed:@"repair_gray_s"] forState:UIControlStateNormal];

...
- (void)awakeFromNib {
    ...
    [self.collectionView registerClass:[RepairImageSmallCell class] forCellWithReuseIdentifier:RepairImageSmallCellIdentifier];
}
...
{
    RepairImageSmallCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:RepairImageSmallCellIdentifier forIndexPath:indexPath];
    if (!cell) {
        NSArray *objects = [[NSBundle mainBundle] loadNibNamed:@"RepairImageSmallCell" owner:self options:nil];
        for (NSObject *o in objects) {
            if ([o isKindOfClass:[RepairImageSmallCell class]]) {
                cell = (RepairImageSmallCell *)o;
                break;
            }
        }
    }

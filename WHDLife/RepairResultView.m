...
@implementation RepairResultView
...
- (IBAction)submitAction:(id)sender {
    ...
    NSString *replyRepairSign = [Tool serializeSign:[NSString stringWithFormat:@"%@%@", api_base_url, api_modiRepairWorkOver] params:param];
    NSString *replyRepairUrl = [NSString stringWithFormat:@"%@%@", api_base_url, api_modiRepairWorkOver];
    
    ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:replyRepairUrl]];
    [request setUseCookiePersistence:NO];
    [request setTimeOutSeconds:30];
    
    [request setPostValue:AccessId forKey:@"accessId"];
    [request setPostValue:replyRepairSign forKey:@"sign"];

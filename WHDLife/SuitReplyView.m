...
- (IBAction)submitAction:(id)sender {
    ...
    NSString *replySuitSign = [Tool serializeSign:[NSString stringWithFormat:@"%@%@", api_base_url, api_modiSuitWorkOver] params:param];
    NSString *replySuitUrl = [NSString stringWithFormat:@"%@%@", api_base_url, api_modiSuitWorkOver];
    
    ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:replySuitUrl]];
    [request setUseCookiePersistence:NO];
    [request setTimeOutSeconds:30];
    
    [request setPostValue:AccessId forKey:@"accessId"];
    [request setPostValue:replySuitSign forKey:@"sign"];
